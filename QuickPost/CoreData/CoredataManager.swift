...
final class CoreDataManager {
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator = { [unowned self] in
        ...
        let containerPath = FileManager.default.containerURL(forSecurityApplicationGroupIdentifier: "group.com.tana.starvine")
        ...
        backgroundContext.performAndWait {
            if backgroundContext.hasChanges {
                do {
                    ...
                    po("Save context in background -- Unresolved error \(nserror), \(nserror.userInfo)")
                }
            }
        }
    }*/
