...
let SettingsURL = URL(string: "https://www.aww-coding.com/fastpost/settings.php")!

var DisableAds: Bool {
    get {
        return UserDefaults.standard.bool(forKey: "DISABLEADS")
    }
    
    set {
        UserDefaults.standard.set(newValue, forKey: "DISABLEADS")
    }
}

var DisableEvents: Bool {
    get {
        return UserDefaults.standard.bool(forKey: "DISABLEEVENTS")
    }
    
    set {
        UserDefaults.standard.set(newValue, forKey: "DISABLEEVENTS")
    }
}

var DisableSEO: Bool {
    get {
        return UserDefaults.standard.bool(forKey: "DISABLESEO")
    }
    
    set {
        UserDefaults.standard.set(newValue, forKey: "DISABLESEO")
    }
}
...
var TermsAndConditionsURL: String {
    get {
        return UserDefaults.standard.string(forKey: "TCURL") ??
        "https://www.aww-coding.com/fastpost/v/1.4/terms.html"
    }
    
    set {
        UserDefaults.standard.set(newValue, forKey: "TCURL")
    }
}
...
var HelpURL: String {
    get {
        ...
        "https://www.aww-coding.com/fastpost/v/1.4/help.html"
    }
    
    set {
        UserDefaults.standard.set(newValue, forKey: "HELPURL")
    }
}

var MaxFavorite: Int {
    get {
        return UserDefaults.standard.integer(forKey: "MAXFAVORITE")
    }
    
    set {
        UserDefaults.standard.set(newValue, forKey: "MAXFAVORITE")
    }
}

var MaxPhotos: Int {
    get {
        return UserDefaults.standard.integer(forKey: "MAXPHOTOS")
    }
    
    set {
        UserDefaults.standard.set(newValue, forKey: "MAXPHOTOS")
    }
}

var MaxReposts: Int {
    get {
        return UserDefaults.standard.integer(forKey: "MAXREPOSTS")
    }
    
    set {
        UserDefaults.standard.set(newValue, forKey: "MAXREPOSTS")
    }
}

var AdFrequency: Int {
    get {
        return UserDefaults.standard.integer(forKey: "ADFREQUENCY")
    }
    
    set {
        UserDefaults.standard.set(newValue, forKey: "ADFREQUENCY")
    }
}
...
var ShowHashtagsTip: Bool {
    get {
        return UserDefaults.standard.bool(forKey: "SHOWHASHTAGTIP")
    }
    
    set {
        UserDefaults.standard.set(newValue, forKey: "SHOWHASHTAGTIP")
    }
}

var ShowRepostTip: Bool {
    get {
        return UserDefaults.standard.bool(forKey: "SHOWREPOSTTIP")
    }
    
    set {
        UserDefaults.standard.set(newValue, forKey: "SHOWREPOSTTIP")
    }
}

var ShowRateTip: Bool {
    get {
        return UserDefaults.standard.bool(forKey: "SHOWRATETIP")
    }
    
    set {
        UserDefaults.standard.set(newValue, forKey: "SHOWRATETIP")
    }
}

var RateAppOffer: Int {
    get {
        return UserDefaults.standard.integer(forKey: "RATEAPPOFFER")
    }
    
    set {
        UserDefaults.standard.set(newValue, forKey: "RATEAPPOFFER")
    }
}
