...
final class AdManager {
    ...
    private var adIndex: Int {
        get {
            return UserDefaults.standard.integer(forKey: "ADD_INDEX")
        }
        
        set {
            UserDefaults.standard.set(newValue, forKey: "ADD_INDEX")
        }
    }
    
    private var numOfActions: Int {
        get {
            return UserDefaults.standard.integer(forKey: "ADD_NUM_OF_ACTIONS")
        }
        
        set {
            UserDefaults.standard.set(newValue, forKey: "ADD_NUM_OF_ACTIONS")
        }
    }
    
    private var active: Bool {
        get {
            return UserDefaults.standard.bool(forKey: "ADS_ARE_ACTIVE")
        }
        
        set {
            UserDefaults.standard.set(newValue, forKey: "ADS_ARE_ACTIVE")
        }
    }
