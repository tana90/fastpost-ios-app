...
extension FavoritesViewController: UICollectionViewDelegateFlowLayout {
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if let label = cell.viewWithTag(100) as? UILabel,
            ...
            text.set(color: UIColor(red: 24/255, green: 86/255, blue: 133/255, alpha: 1), for: "#")
...
extension FavoritesViewController {
    ...
    func insert(hashTag: String, from textField: UITextField) {
        ...
        if PROVersion || favoritesFetchedResultsController.fetchedObjects?.count ?? 0 < MaxFavorite {
            ...
            let alertViewController = UIAlertController(title: "Favorites limit reached", message: "You have reach the limit of \(MaxFavorite) free saved hashtags. To continue using the app upgrade to PRO.", preferredStyle: style)
            alertViewController.view.tintColor = UIColor(red: 24/255, green: 86/255, blue: 133/255, alpha: 1)
