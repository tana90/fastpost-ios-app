...
final class StoreViewController: UIViewController {
    ...
    var unpurchasedText = """
    Get UNLIMITED hastags for Instagram photos.  Analize as many picture as you want and get the best HASHTAGS
    """
...
//                self!.updateUI()
        ...
        EventHandler.shared.upgradeToPRO {
            DispatchQueue.main.safeAsync { [weak self] in
                ...
                if PROVersion {
                    ...
                    let alertViewController = UIAlertController(title: "Congratulations", message: "Congratulations for your purchase. Your are now a PRO 👏", preferredStyle: .alert)
                    alertViewController.view.tintColor = UIColor(red: 24/255, green: 86/255, blue: 133/255, alpha: 1)
    ...
    func updateUI() {
        if PROVersion {
            ...
            Get UNLIMITED hastags for Instagram photos.  Analize as many picture as you want and get the best HASHTAGS for only
            \(CachedPrice)
            """
    ...
    @objc func handlePurchaseNotification(_ notification: Notification) {
        ...
        guard let productID = notification.object as? String,
            productID == "com.tana.starvine.proiap" else {
