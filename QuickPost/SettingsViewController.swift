...
var allowAutoSelect: Bool {
    get {
        return UserDefaults.standard.bool(forKey: "ALLOW_AUTO_SELECT")
    }
    
    set {
        UserDefaults.standard.set(newValue, forKey: "ALLOW_AUTO_SELECT")
    }
}
...
var tcSafariViewController: SFSafariViewController = {
    ...
    viewController.preferredControlTintColor = UIColor(red: 24/255, green: 86/255, blue: 133/255, alpha: 1)
        ...
        if indexPath.section == 2 {
            if indexPath.row == 1 {
                ...
                if RateAppOffer == 0 {
                    ...
                    let alertViewController = UIAlertController(title: "🎉 Congratulations", message: "Now you have 5 free more photos", preferredStyle: .alert)
