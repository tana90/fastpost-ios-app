...
final class HomeViewController: UIViewController {
    ...
    @IBAction func selectPhotoAction() {
        ...
        if MaxPhotos + RateAppOffer > Int(AppManager.loadNumberOfScans()) ?? 0 || PROVersion {
            ...
            imagePicker.view.tintColor = UIColor(red: 24/255, green: 86/255, blue: 133/255, alpha: 1)
            ...
            let alertViewController = UIAlertController(title: "Photos limit reached", message: "You have reach the limit of \(MaxPhotos + RateAppOffer) free actions. To continue using the app upgrade to PRO.", preferredStyle: style)
            alertViewController.view.tintColor = UIColor(red: 24/255, green: 86/255, blue: 133/255, alpha: 1)
    ...
    @IBAction func postAction() {
        ...
        if previewImageView.image != nil {
            AdManager.shared.registerAction(onView: navigationController?.view)
            ...
            Tag.fetchSelected { (results) in
                ...
                DispatchQueue.main.safeAsync { [weak self] in
                    ...
                    guard results.count > 0 else {
                        ...
                        alertViewController.view.tintColor = UIColor(red: 24/255, green: 86/255, blue: 133/255, alpha: 1)
                        let openAction = UIAlertAction(title: "Open Instagram", style: .default) { [weak self] (alert) in
                            guard let _ = self else { return }
                            self!.openInsagram()
                        }
                    ...
                    let alertViewController = UIAlertController(title: "Copied to clipboard", message: "Hashtags copied to clipboard.\nPaste them in Instagram app when you post the photo. 👏", preferredStyle: .alert)
                    alertViewController.view.tintColor = UIColor(red: 24/255, green: 86/255, blue: 133/255, alpha: 1)
                    let openAction = UIAlertAction(title: "Open Instagram", style: .default) { (alert) in
                        self!.openInsagram()
                    }
...
extension HomeViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if !tag.utility {
            ...
            if tag.selected {
                cell.backgroundColor = UIColor(red: 24/255, green: 86/255, blue: 133/255, alpha: 1)
                selectView.backgroundColor = UIColor(red: 24/255, green: 86/255, blue: 133/255, alpha: 1)
                label.textColor = .white
                cell.borderColor =  UIColor(red: 24/255, green: 86/255, blue: 133/255, alpha: 1)
            } else {
            ...
            if selectView.backgroundColor != UIColor(red: 24/255, green: 86/255, blue: 133/255, alpha: 1) {
                selectView.backgroundColor = UIColor(red: 24/255, green: 86/255, blue: 133/255, alpha: 1)
            }
            label.textColor = .black
            text.set(color: UIColor(red: 24/255, green: 86/255, blue: 133/255, alpha: 1), for: "Add new")
...
extension HomeViewController {
    ...
    func openInsagram() {
        ...
        EventManager.shared.sendEvent(name: "post_photo", type: "action")
    ...
    func showRateTip() {
        ...
        if !PROVersion {
            ...
            if ShowRateTip == false {
                ...
                DispatchQueue.main.safeAsync { [weak self] in
                    guard let _ = self else { return }
                    let alertViewController = UIAlertController(title: "FastPost", message: "Rate our app and get 5 free more actions.", preferredStyle: .alert)
                    alertViewController.view.tintColor = UIColor(red: 24/255, green: 86/255, blue: 133/255, alpha: 1)
